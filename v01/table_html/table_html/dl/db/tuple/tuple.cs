...
namespace pl2.table.tuple
{
    ...
    public class Tuple_tuple : Domain
    {
        ...
        private Domain_enum field_type_inner;
        ...
        public Domain_enum field_type { get { return field_type_inner; } }
        ...
        public Tuple_tuple(string field_name_new, Domain_enum field_type_new, Int32 field_len_new, Int32 field_dec_new)
        {
